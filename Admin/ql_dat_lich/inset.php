                        ...
                        <div class="col-sm-10 col-lg-6 offset-sm-1 offset-lg-3">
                            <div class="form-bg">
                                ...
                                if (isset($_POST['sup'])) {
                                   ...
                                   $result = $ins->them_dv($ten,$gia,$giam_gia,$mo_ta,$image);
                                }
                                ...
                                if (isset($result)) {
                                    echo $result;
                                ?>
                                 <script> location.replace("dich_vu.php"); </script>
                                <?php
                                }
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <input type="text" name="ten_dv" class="form-control" placeholder="Nhập Tên">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="giam_gia" class="form-control" placeholder="Nhập số giảm Giá">
                                    </div> 
